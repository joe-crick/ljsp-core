...
// Credit where credit is due: Code written by Evgeny Poberezkin (fast-deep-equal)
function _equal(a: any, b: any) {
  ...
  if (a && b && typeof a == "object" && typeof b == "object") {
    ...
    if (Array.isArray(a)) {
      ...
      for (i = length; i-- !== 0; ) if (!_equal(a[i], b[i])) return false;
      return true;
    }
    ...
    if (a instanceof Map && b instanceof Map) {
      ...
      for (i of a.entries()) if (!_equal(i[1], b.get(i[0]))) return false;
      return true;
    }
