...
export function compare(left, right) {
    // prettier-ignore
    return cond(() => number$(left), () => compareNumbers(left, right), () => boolean$(left), () => compareBools(left, right), () => string$(left), () => compareStrings(left, right), () => Array.isArray(left), () => compareArrays(left, right));
}
function compareNumbers(left, right) {
    // prettier-ignore
    return cond(left > right, 1, left === right, 0, left < right, -1);
}
...
function compareBools(left, right) {
    // prettier-ignore
    return cond(left && !right, 1, !left && right, -1, left && right || !left && !right, 0);
}
