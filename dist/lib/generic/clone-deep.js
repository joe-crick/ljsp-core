...
function _clone(opts) {
    ...
    function clone(o) {
        ...
        if (o instanceof WeakMap)
            return new WeakMap(cloneArray(Array.from(o), clone));
        if (o instanceof WeakSet)
            return new WeakSet(cloneArray(Array.from(o), clone));
        const o2 = {};
        for (let k in o) {
    ...
    function cloneProto(o) {
        ...
        if (o instanceof WeakMap)
            return new WeakMap(cloneArray(Array.from(o), cloneProto));
        if (o instanceof WeakSet)
            return new WeakSet(cloneArray(Array.from(o), cloneProto));
        const o2 = {};
        for (let k in o) {
            const cur = o[k];
            if (typeof cur !== "object" || cur === null) {
